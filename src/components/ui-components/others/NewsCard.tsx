    ...
    <Box rounded="2xl" borderWidth="1" w="100%">
      ...
      >
        ...
        <Column>
          ...
          <Text italic>
            As the world teeters on the precipice of environmental devastation,
            BirdLife's contribution to the 2023 IUCN Red List provides a stark
            reminder that we are losing birds at an unprecedented rate...
          </Text>
        </Column>
